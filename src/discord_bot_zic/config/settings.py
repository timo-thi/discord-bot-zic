...
class Settings(BaseSettings):
    ...
    sqlite_path: Path = Field(default=Path("./data/discord-bot-zic.sqlite3"), alias="SQLITE_PATH")
    ...
    default_volume_percent: int = Field(default=100, alias="DEFAULT_VOLUME_PERCENT", ge=0, le=100)
    autocomplete_limit: int = Field(default=25, alias="AUTOCOMPLETE_LIMIT", ge=1, le=25)
    store_list_page_size: int = Field(default=10, alias="STORE_LIST_PAGE_SIZE", ge=1, le=25)
